  ...
  return (
    <div className="min-h-screen bg-[#F6F8FA] font-body text-ink antialiased relative">
      ...
      <div className="bg-brand-blue/10 border-b border-brand-blue/10 text-center py-2.5 px-4 text-xs font-semibold text-brand-navy relative z-20">
        ⚡ Orientation starting 26 September 2026. Only a few seats remaining for the Immersion Program.
      </div>
            ...
            <CardContent className="p-6 sm:p-8">
              <Accordion>
                ...
                <AccordionItem question="When does the next cohort start, and how many seats are available?">
                  The Immersion Program begins on 26 September 2026. We keep each batch deliberately small to protect the quality of mentorship, so seats are limited and registration closes once they are filled.
                </AccordionItem>
